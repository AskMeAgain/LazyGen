package io.github.askmeagain.lazygen.calculator.simple.mapstructwithoutannotation;
...
@GenerateLazyClass(ResultType.MAPSTRUCT_COMPATIBLE_WITHOUT_ANNOTATION)
public interface MapStructInterfaceWithoutAnnotation {
